...
{% hint style="info" %}
If you're evaluating the platform for your team rather than yourself, jump to [Core concepts](/kasula-docs/documentation/core-concepts/core-concepts.md) first — it'll save time when you set things up properly.
{% endhint %}
